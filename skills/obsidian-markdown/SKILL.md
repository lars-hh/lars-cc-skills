...
version: 1.0.0
description: |
  Create and edit valid Obsidian Flavored Markdown with wikilinks, embeds, callouts,
...
| **lars-para** | Frontmatter `wikilink_style: lars-para` or invocation flag `--wikilink-style lars-para`. | Suggests semantic paths from a PARA vault: `[[People/...]]`, `[[Projects/...]]`, `[[Notes/...]]`, `[[Daily/YYYY-MM/...]]`, etc. See [WIKILINKS-LARS-PARA.md](references/WIKILINKS-LARS-PARA.md) for all 10 path patterns. |
...
See [WIKILINKS-LARS-PARA.md](references/WIKILINKS-LARS-PARA.md) for all 10 path patterns, slug rules, and activation details.
